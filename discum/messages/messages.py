...
class Messages(object):
	...
	def searchMessages(self,guildID,channelID,userID,mentionsUserID,has,beforeDate,afterDate,textSearch,afterNumResults): #same as the search feature on servers, afterNumResults is multiples of 25 and indicates after which messages (type int)
		url = self.discord+"guilds/"+guildID+"/messages/search?"
		queryparams = ""
