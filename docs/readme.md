...
bot.login(email, password, undelete=False, captcha=None, source=None, gift_code_sku_id=None)
bot.getXFingerprint()
bot.getBuildNumber()
...
bot.reply(channelID, messageID, message, nonce="calculate", tts=False, embed=None, allowed_mentions={"parse":["users","roles","everyone"],"replied_user":False}, bot.sticker_ids=None, file=None, isurl=False)
...
bot.me(with_analytics_token=None)
