...
A: A recent commit to the github repo has a version-breaking change: log is now a dictionary instead of a boolean. The reason for this is to allow the dev/user to specify a log file if they wish. You can either update your code according to https://github.com/Merubokkusu/Discord-S.C.U.M/blob/master/docs/using.md#initiate-client or use https://github.com/Merubokkusu/Discord-S.C.U.M/releases/tag/v1.2.1 for now. However, we recommend updating when v1.2.2 comes out.       
